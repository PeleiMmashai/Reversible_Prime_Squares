			...
			if(palindrome(result)==false)
			{
				if(squareNumber(rev))
				{
					if(isPrime(sqroot))
					{
						...
						printf("%d -> Sqrt of reversed square number not prime", itr);
					}
				}
				else{
					printf("%d-> Reversed square number is not a Square Number",itr);
				}
			}
			else {
				printf("%d-> Reversed square number is a palindrome",itr);
			}
		}
		else{
			printf("%d-> Not prime!",itr);
		}
		printf("\n..................................................\n");
		itr++; 
	}
